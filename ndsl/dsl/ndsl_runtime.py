...
class NDSLRuntime:
    ...
    def __init__(
        ...
        if optimization_config is None:
            ...
            # - Defaults for optimization config could go here.
            # - Independent of (potential) defaults in `orchestrate()` we could have
            #   specialized defaults here for NDSLRuntime code.
